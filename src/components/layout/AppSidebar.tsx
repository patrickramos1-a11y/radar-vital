...
import { Settings, LayoutDashboard, Box, MessageSquare, FileUp, LucideIcon, BarChart3, Target, Globe2, ShieldCheck, Landmark, Sparkles } from "lucide-react";
...
const navigationItems: NavItem[] = [
  ...
  { title: "Universo Ramos", icon: Globe2, href: "/universo-ramos" },
  { title: "Oportunidades", icon: Sparkles, href: "/oportunidades" },
  ...
  { title: "Auditorias", icon: ShieldCheck, href: "/auditorias" },
  { title: "Tesouro", icon: Landmark, href: "/tesouro" },
