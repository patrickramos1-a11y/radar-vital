...
export interface VisualFilterFlags {
  priority: boolean;
  highlighted: boolean;
  withJackbox: boolean;
  checked: boolean;
...
interface VisualPanelFiltersProps {
  ...
  filterFlags: VisualFilterFlags;
  onFilterFlagToggle: (flag: keyof VisualFilterFlags) => void;
...
export function VisualPanelFilters({
  ...
  return (
    <TooltipProvider delayDuration={200}>
      <div className="flex flex-wrap items-center gap-3 px-6 py-3 bg-muted/30 border-b border-border">
        {/* Search */}
